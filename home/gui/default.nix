{ config, lib, pkgs, ... }: {
    xdg.configFile."gtkrc-2.0".source = ../../dotfiles/gtkrc-2.0;
    xdg.configFile."gtk-2.0/gtkfilechooser.ini".source = ../../dotfiles/gtk-2.0/gtkfilechooser.ini;
    xdg.configFile."gtk-3.0/settings.ini".source = ../../dotfiles/gtk-3.0/settings.ini;
    home.file.".Xdefaults".source = ../../dotfiles/Xdefaults;
    home.file.".Xresources.d/".source = ../../dotfiles/Xresources.d;
    home.file.".Xresources".source = ../../dotfiles/Xresources.d/.Xresources.gruvbox-dark;
    home.file.".looking-glass-client.ini".source = ../../dotfiles/looking-glass-client.ini;
